...
export default observer(function ActivityDetailedHeader({ activity }: Props) {
    ...
    if (activity.isHost) {
        ...
        button = <Button onClick={updateAttendance} loading={loading}>Cancel attendance</Button>
    } else {
        button = <Button disabled={activity.isCancelled} onClick={updateAttendance} loading={loading} color='teal'>Join Activity</Button>
    }
